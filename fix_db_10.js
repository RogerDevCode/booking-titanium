...
if (isDup) {
    if (!isDup.parameters.conditions) {
        isDup.parameters.conditions = { options: { caseSensitive: true, leftValue: "", typeValidation: "strict" }, conditions: [], combinator: "and" };
    }
    isDup.parameters.conditions.conditions = [{ 
        id: "is_dup", 
...
// Clean up some unneeded properties
delete wf.id;
delete wf.active;
delete wf.createdAt;
delete wf.updatedAt;

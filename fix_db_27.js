...
const wf = {
  ...
  "connections": {
    ...
    "Is Duplicate?": { "main": [[{ "node": "Return Duplicate SCO", "type": "main", "index": 0 }], [{ "node": "Return Duplicate SCO", "type": "main", "index": 0 }]] }
  },
...
async function run() {
  try {
    ...
    if (existing) await axios.delete(apiUrl + '/workflows/' + existing.id, { headers });
    ...
    console.log('Activated Fresh OK');
  } catch (e) {
